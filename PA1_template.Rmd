...
```{r time_Series_Plot_of_the_5_minute_interval}
## The 5-minute interval that, on average, contains the maximum number of steps
...
```{r histogram_with_missing_data_filled_in}
...
```{r Panel_plot_comparing_the_average_number_of_steps_taken }
## Panel plot comparing the average number of steps taken 
## per 5-minute interval across weekdays and weekends
